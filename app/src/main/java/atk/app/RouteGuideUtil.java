...
import atk.msg.routeguide.FeatureDatabase;
...
public class RouteGuideUtil {
    ...
    /**
     * Gets the default features from configuration.
     */
    public static Config getDefaultFeaturesConfig(Config cfg) {
        return cfg.getConfig("dev.route-guide-db");
    }
    ...
    public static URL getDefaultFeaturesFile() {
        System.out.println(RouteGuideServer.class.getResource("./route_guide_db.json"));
